import svgPaths from "./svg-9i1qcnhox9";
  ...
  return (
    <div className="bg-[#1a3760] relative size-full" data-name="Container">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2.5 items-start justify-start px-[139px] py-[60px] relative size-full">
          <Container12 />
        </div>
      </div>
    </div>
